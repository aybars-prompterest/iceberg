...
const DEFAULTS: Record<string, string> = {
  ...
  hero_description:
    "We build and launch your product to the global market in weeks.",
  ...
  cta_banner_description:
    "Book your free intro call and let's explore how we can bring your idea to life.",
  cta_banner_label: "Schedule a Free Call",
  cta_banner_href: "#",
  // Services Cards
  services_card_0_title: "Services",
  services_card_0_description:
